...
/*Task 1: counterMaker()
  ...
  Everyhint that counter 1 needs is inside the function. Counter two pulls code from the Global veriables/
  2. Which of the two uses a closure? How can you tell?
  Counter 2
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     Counter 1-When let count does not need to attach to any other function but counter marker
     counter 2- Where there is a need to have multiple counters so let count needs to be at a Global level 
*/
